...
var request = require('request'); //          request({ url:url,json:true},(error,response) => {
...
var forecast = function forecast(_long, lat, callback) {
  var url = 'http://api.weatherstack.com/current?access_key=932be7a8e405d40c4da074408a8202e1&query=' + lat + ',' + _long + '&units=m';
  request({
    url: url,
    json: true
  }, function (error, _ref) {
